...
# As part of deploying your application you’ll need to 
# run ./manage.py collectstatic to put all your static 
# files into STATIC_ROOT. (If you’re running on Heroku 
# then this is done automatically for you.)
